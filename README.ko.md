...
Align은 이해한 내용을 설명하기 전에 확인 가능한 근거로 요청을 검토하고,
결과를 바꿀 수 있는 중요한 누락·모순·위험·검증되지 않은 가정·예외·더 단순한
대안만 짚습니다.

필수 질문과 선택적 개선을 구분하고, 거절한 개선은 닫으며, 독립적인 질문은 묶고
의존적인 질문만 순서대로 묻습니다. 구체적으로 지목된 고위험 작업물에는 별도의
Toxic Review를 제안할 수 있으며, 사용자가 선택할 때만 시작합니다.
