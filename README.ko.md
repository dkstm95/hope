...
| “코드베이스를 청소하고 싶어요.” | **Sweep** | 코드베이스 유지보수를 계획하고 승인한 작업만 적용합니다. |
...
Sweep은 dead code, 추상화, 테스트, 의존성, 성능, 릴리스, 복구를 포함한
[모든 유지보수 영역](docs/sweep.md#codebase-maintenance-categories)을 점검합니다.
