...
export const staticPluginFiles = Object.freeze([
  ...
  "plugins/hope/skills/visualize/LICENSE.diagram-design",
  "plugins/hope/skills/visualize/SKILL.md",
  "plugins/hope/skills/visualize/agents/openai.yaml",
  "plugins/hope/skills/visualize/references/chart-standard.md",
  "plugins/hope/skills/visualize/references/diagram-standard.md",
