...
5. Replace jargon, foreign phrases, and technical terms with everyday language
   when possible. Explain a necessary term when it first appears.
...
- In Markdown and plain text, separate consecutive prose paragraphs with one
  blank line.
- In other formats, use the format's native paragraph structure.
...
- Does each paragraph have one clear job and use one sentence when that improves
  meaning, readability, or rhythm?
- If related sentences stay together, would splitting them harm meaning, flow,
  or voice, or conflict with the target format?
- Does the output use its native paragraph structure, including one blank line
